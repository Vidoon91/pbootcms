...
class ConfigModel extends Model
{
    ...
    // 修改应用配置值，保留 JSON 等原始文本
    public function modTextValue($name, $value)
    {
    ...
    // 扩展配置值字段长度，避免较长 JSON 被截断
    public function ensureValueText()
    {
        return parent::amd('ALTER TABLE ay_config MODIFY `value` TEXT');
    }
